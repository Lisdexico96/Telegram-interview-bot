...
You have two bots in this project. Below is the step-by-step flow for each when someone uses the bot on Telegram.

---

## 1. Python bot (`python3 bot.py`) — Interview with 5 questions
...
## 2. Node.js bot (`npm start`) — AI evaluation then details collection
...
Use **Python bot** for a structured multi-question interview with scores and one-time completion. Use **Node.js bot** for quick AI screening and collecting contact details only from those who PASS.
