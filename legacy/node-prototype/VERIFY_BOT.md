# Archived Node Bot Verification

This file documents the old Node.js prototype that now lives in `legacy/node-prototype/`.
It is kept for reference only and does not describe the active Python bot in the project root.
